...
const mg = mailgun.client({
    username: 'api',
    key: process.env.MAILGUN_API_KEY || 'e9dd9daa8f4a593614eb25558f8ab929-79295dd0-c72fc8af' // replace 'key-yourkeyhere' with your API key
});

app.get('/', function(request, response) {
    response.sendFile(__dirname + '/index.html'); // sending file to the client using sendFile
});
